...
#define COCOAPODS_VERSION_MINOR_CDTDatastore 12
#define COCOAPODS_VERSION_PATCH_CDTDatastore 1

// CDTDatastore/no-arc
#define COCOAPODS_POD_AVAILABLE_CDTDatastore_no_arc
#define COCOAPODS_VERSION_MAJOR_CDTDatastore_no_arc 0
#define COCOAPODS_VERSION_MINOR_CDTDatastore_no_arc 12
#define COCOAPODS_VERSION_PATCH_CDTDatastore_no_arc 1
...
#define COCOAPODS_VERSION_PATCH_CloudantQueryObjc 1

// CloudantToolkit
#define COCOAPODS_POD_AVAILABLE_CloudantToolkit
#define COCOAPODS_VERSION_MAJOR_CloudantToolkit 0
#define COCOAPODS_VERSION_MINOR_CloudantToolkit 1
#define COCOAPODS_VERSION_PATCH_CloudantToolkit 2
...
#define COCOAPODS_VERSION_MAJOR_IMFCore 0
#define COCOAPODS_VERSION_MINOR_IMFCore 1
#define COCOAPODS_VERSION_PATCH_IMFCore 2

// IMFGoogleAuthentication
#define COCOAPODS_POD_AVAILABLE_IMFGoogleAuthentication
#define COCOAPODS_VERSION_MAJOR_IMFGoogleAuthentication 0
#define COCOAPODS_VERSION_MINOR_IMFGoogleAuthentication 1
